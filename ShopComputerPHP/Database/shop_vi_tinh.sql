...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2016 at 03:49 AM
...
(8, 0, 1, 'Công ty cổ phần thương mại dịch vụ Alphatek Computer', '', '<div style="padding-left: 30px;">\r\n<div>Địa chỉ: 357 L&ecirc; Hồng Ph&ograve;ng, P2, Q10</div>\r\n\r\n<div>ĐT: 38337980 - Fax: 38337982</div>\r\n\r\n<div>Email: alphatek@hcmuns.edu.vn</div>\r\n</div>\r\n\r\n<h3>Bản đồ đường đi</h3>\r\n\r\n<p><img alt="" src="http://localhost:81/src/LTW-PHP2/images/map_.jpg" style="height:196px; width:257px" /></p>\r\n', '2016-12-16 06:54:58', '2016-12-16 06:54:58', '1970-01-01 12:00:00', 0, 1);
...
INSERT INTO `ct_hoa_don` (`so_hoa_don`, `ma_san_pham`, `so_luong`, `don_gia`, `stt`, `trang_thai`) VALUES
('1', '31', 5, 200000, 1, 0),
('1', '33', 10, 150000, 3, 0),
('1', '33', 10, 150000, 4, 0),
('1', '33', 2, 50000, 6, 0),
...
INSERT INTO `hoa_don` (`so_hoa_don`, `ngay_hd`, `ma_khach_hang`, `tri_gia`, `tien_dat_coc`, `con_lai`, `hinh_thuc_thanh_toan`, `ghi_chu`, `trang_thai`) VALUES
(1, '2011-03-09', '1', 550000, 0, 0, '', '', 1),
(2, '2011-08-27', '10', 6160000, 0, 0, '', '', 0),
(3, '2010-10-31', '11', 5000000, 0, 0, '', '', 1),
(4, '2016-12-16', '12', 4210000, 0, 0, 'Thẻ tín dụng', '', 0),
(5, '2016-12-18', '12', 15675000, 0, 0, 'Thẻ tín dụng', '', 0),
(6, '2016-12-18', '12', 9120000, 0, 0, 'Chuyển khoản', '', 0),
(7, '2016-12-18', '12', 8480000, 0, 0, 'Tiền mặt', '', 0);
...
(11, '', '', 0, '0000-00-00', '', '', ''),
(12, 'Trần Văn Thắng', '21232f297a57a5a743894a0e4a801fc3', 1, '2016-12-15', 'admin', 'admin', 'admin');
...
INSERT INTO `loai_san_pham` (`ma_loai`, `ten_loai`, `mo_ta`, `ma_loai_cha`, `hinh`) VALUES
...
(194, 'Máy tính bảng', NULL, 0, 'maytinhbang.jpg'),
(195, 'Asus', 'Máy tính bảng Asus', 196, 'maytinhbang_asus.jpg'),
(196, 'Dell', 'Máy tính bảng Dell', 194, 'maytinhbang_dell.jpg'),
(197, 'Lenovo', 'Máy tính bảng Lenovo', 194, 'maytinhbang_lenovo.jpg'),
(198, 'Apple', 'Máy tính bảng Apple', 194, 'maytinhbang_apple.jpg'),
(199, 'Acer', 'Máy tính bảng Acer', 194, 'maytinhbang_acer.jpg'),
(200, 'Toshiba', 'Máy tính bảng Toshiba', 194, 'maytinhbang_toshiba.jpg');
...
(18, 3, 'Trần Văn Thắng ', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', '2016-12-21', '2016-12-28', 1);

-- --------------------------------------------------------

--
-- Table structure for table `nhan_tin`
--
...
(209, 'ADATA™ 4.0GB (2 x 2GB) DDR2 bus 800MHz', '12', 'ADATA™ 4.0GB (2 x 2GB) DDR2 bus 800MHz - VITESTA G series', '', 2000000, 'ADATA____4.0GB___4bad64fd00b94.jpg', 1, 144, '2011-03-11'),
...
(44, 'INTEL DG31PR', '10', 'INTEL DG31PR - Chipset G31 (Core 2 Duo & C2Q) - SK 775. 2x DDR2 667/800 (Max 4GB Ram) VGA, Sound 6 channel & Nic Gigabit onboard. 2x PCI- 1x PCI 16x , 4x SATA ; 1333/1066/800 FSB', '', 1190000, 'INTEL_DG31PR_4af11d21903e8.jpg', 1, 112, '2011-03-11'),
...
(59, 'Ổ cứng SamSung 160 GB Serial ATA II', '13', 'SamSung 160 GB Serial ATA II (3 Gb/s); 7200 rpm; 8MB Cache', '', 850000, '____c___ng_SamSu_4af1227aa1464.jpg', 0, 381, '2011-03-11'),
(204, 'Ổ cứng SamSung 1.0 TB Serial ATA II', '13', 'SamSung 1.0 TB Serial ATA II (3 Gb/s); 7200 rpm; 16MB Cache', '', 1980000, '____c___ng_SamSu_4b45503e40255.jpg', 1, 187, '2011-03-11'),
...
(113, 'D-Link Switching 10/100 - 8 Port (DES-1008D/E)', '45', 'D-Link Switching 10/100 - 8 Port (DES-1008D/E)', '<p>D-Link Switching 10/100 - 8 Port (DES-1008D/E)<br />Bảo hành: 12 tháng</p>', 290000, 'D_Link_Switching_4af26e5f6124b.jpg', 0, 6, '2011-03-11'),
...
(168, 'HP Compaq Presario CQ3016L ( PC Dos )', '28', 'Pentium Dual Core E5200(2.5GHz/800M/2MB) / Intel G31 Express Chipset / 1GB-DDR2 / Sound 5.1 / HDD 250GB / DVD Intel Graphics Intergrated / PCI E 16X/10-100Mbps NIC / Modem / Free-DOS/', '<div>Pentium Dual Core E5200(2.5GHz/800M/2MB) / Intel G31 Express Chipset / 1GB-DDR2 / Sound 5.1 / HDD 250GB / DVD Intel Graphics Intergrated / PCI E 16X/10-100Mbps NIC / Modem  / Free-DOS/<br />BH: 12 tháng</div>', 5000000, 'HP_Compaq_Presar_4af2cbd08af76.jpg', 0, 467, '2011-03-11'),
...
--
-- Table structure for table `san_pham_tra_gop`
--

CREATE TABLE `san_pham_tra_gop` (
  `ma_san_pham` int(11) NOT NULL,
  `tu_ngay` date NOT NULL,
  `den_ngay` date NOT NULL,
  `thong_tin_tra_gop` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `san_pham_tra_gop`
--

INSERT INTO `san_pham_tra_gop` (`ma_san_pham`, `tu_ngay`, `den_ngay`, `thong_tin_tra_gop`) VALUES
(28, '2014-06-30', '2014-07-31', 'Tặng Pin sạc dự(SLCH)'),
(29, '2014-06-30', '2014-07-31', 'Kèm thẻ nhớ 8GB(SLCH)'),
(31, '2014-06-30', '2014-07-30', 'Tặng Ốp lưng Iphone 5 (SLCH)'),
(37, '2014-06-30', '2014-07-30', 'Tặng Pin sạc dự phòng(SLCH)');
...
--
-- Indexes for table `san_pham_tra_gop`
--
ALTER TABLE `san_pham_tra_gop`
  ADD PRIMARY KEY (`ma_san_pham`);
...
--
ALTER TABLE `hoa_don`
  MODIFY `so_hoa_don` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `loai_bai_viet`
  MODIFY `ma_loai_bai_viet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=198;
--
...
--
-- AUTO_INCREMENT for table `nhan_tin`
--
ALTER TABLE `nhan_tin`
