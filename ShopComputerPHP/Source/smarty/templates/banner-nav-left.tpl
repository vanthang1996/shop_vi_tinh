    ...
    <nav class="navbar nav_bottom"> 
      ...
      <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
         {foreach $navs as $nav}
          <li class="dropdown mega-dropdown active"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">{$nav->ten_loai}<span class="caret"></span></a>
            <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
              <div class="w3ls_vegetables">
                <ul>
                {foreach $subs[$nav->ma_loai] as $sub}
                  <li><a href="products.php?ma_loai={$sub->ma_loai}">{$sub->ten_loai}</a></li>
  				{/foreach}
                </ul>
              </div>
            </div>
